...
const chtkSeriesData: ChtkSeries[] = [
    {
        id: 'termoregulator',
        name: 'ЧТК',
        url: '/Teplypolzdely/HTK/speizialnygreyhicabel/CN-10',
        image: '/images/seris/СН-10.png',
      ...
      },
      {
        id: 'termoregulator',
        name: 'ЧТК',
        url: '/Teplypolzdely/HTK/speizialnygreyhicabel/CNGT',
        image: '/images/seris/СНГТ.png',
        logo: '/images/brands/chtklogo.webp',
        description: 'Категория для специального греющего кабеля',
      },
      {
        id: 'termoregulator',
        name: 'ЧТК',
        url: '/Teplypolzdely/HTK/speizialnygreyhicabel/CT-18',
        image: '/images/seris/СТ-18.png',
        logo: '/images/brands/chtklogo.webp',
        description: 'Категория для специального греющего кабеля',
      },
  ...
  return (
    <div style={{ backgroundColor: 'var(--background)' }} className="min-h-screen text-[var(--foreground)] pt-36 md:pt-32 max-w-[88rem] mx-auto">
      ...
      <Head>
        ...
        <meta name="description" content="Купить Специальный греющий кабель СН-10 СНГТ СТ-18 : электронные, с датчиком пола, надежные решения для точного поддержания температуры." />
        <meta property="og:title" content="СН-10 СНГТ СТ-18 — купить специальный греющий кабель, ЧТК  | Elektromos" />
        <meta property="og:description" content="Купить Специальный греющий кабель СН-10 СНГТ СТ-18 : электронные, с датчиком пола, надежные решения для точного поддержания температуры." />
        <meta property="og:url" content="https://elektromos.uz/Teplypolzdely/HTK/speizialnygreyhicabel" />
        <meta property="og:image" content="/images/seris/СН-10.webp" />
        ...
        <div className="lg:w-1/2 lg:h-screen lg:sticky lg:top-0 bg-[#101010] p-4 sm:p-6 md:p-8 lg:p-7 flex flex-col justify-center">
          ...
          <p className="text-white mb-3 md:mb-4 text-sm sm:text-base md:text-lg">
            Откройте для себя превосходные специальный греющий кабель – эталон немецкого качества и элегантного дизайна в мире электрики! Выберите свою любимую серию и откройте для себя мир специального греющего кабеля!
          </p>
          <p className="text-white text-sm sm:text-base md:text-lg">
            — это не просто электрика, это искусство создания совершенного пространства. Выбирайте качество, выбирайте ЧТК!
          </p>
        </div>
                    ...
                    <div className="bg-[#101010] border border-white/20 rounded-xl overflow-hidden transition-all duration-300 hover:border-red-500 hover:shadow-lg h-full">
                      <div className="flex flex-row items-center p-4 md:p-6 h-full min-h-[160px]">
                        <div className="flex-1 pr-4 md:pr-6 flex flex-col justify-center text-left">
                          ...
                          <p className="text-white text-sm md:text-base mb-2 md:mb-4 leading-relaxed">
                            {series.description}
                          </p>
                          <div className="flex   -ml-1 items-center bg-[#272626] rounded-full px-3 py-2 justify-start text-white">
                            
                            <span className="text-xs md:text-sm">Смотреть категорию</span>
                          </div>
                        </div>
                        
                        <div className="flex-shrink-0 w-[300px] h-[300px] sm:w-[300px] sm:h-[300px] md:w-[600px] md:h-[600px] scale-[170%] lg:scale-[260%] lg:w-[600px] lg:h-[600px]">
