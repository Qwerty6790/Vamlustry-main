...
const chtkSeriesData: ChtkSeries[] = [
    {
        id: 'Категория для кабельного теплого пола',
        name: 'ЧТК',
        url: '/Teplypolzdely/HTK/cabelinyteplypol/CN-15',
        image: '/images/seris/СН-15.png',
      ...
      },
      {
        id: 'Категория для кабельного теплого пола',
        name: 'ЧТК',
        url: '/Teplypolzdely/HTK/cabelinyteplypol/CNT-18',
        image: '/images/seris/СНТ-18.png',
        logo: '/images/brands/chtklogo.webp',
        description: 'Категория для кабельного теплого пола',
      },
];
  ...
  return (
    <div style={{ backgroundColor: 'var(--background)' }} className="min-h-screen text-[var(--foreground)] pt-36 md:pt-32 max-w-[88rem] mx-auto">
      ...
      <Head>
        ...
        <meta name="description" content="Купить  Кабельный теплый пол СН-15 СНТ-18 : электронные, с датчиком пола, надежные решения для точного поддержания температуры." />
        <meta property="og:title" content="СН-15 СНТ-18 — купить кабельный теплый пол, ЧТК  | Elektromos" />
        <meta property="og:description" content="Купить Кабельный теплый пол СН-15 СНТ-18 : электронные, с датчиком пола, надежные решения для точного поддержания температуры." />
        <meta property="og:url" content="https://elektromos.uz/Teplypolzdely/HTK/cabelinyteplypol" />
        <meta property="og:image" content="/images/seris/СН-15.webp" />
        ...
        <div className="lg:w-1/2 lg:h-screen lg:sticky lg:top-0 bg-[#101010] p-4 sm:p-6 md:p-8 lg:p-7 flex flex-col justify-center">
          ...
          <p className="text-white mb-3 md:mb-4 text-sm sm:text-base md:text-lg">
            Откройте для себя превосходные теплые полы – эталон немецкого качества и элегантного дизайна в мире электрики! Выберите свою любимую серию и откройте для себя мир теплых полов!
          </p>
