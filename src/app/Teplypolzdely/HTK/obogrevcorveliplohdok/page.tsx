...
const chtkSeriesData: ChtkSeries[] = [
    {
        id: 'termoregulator',
        name: 'ЧТК',
        url: '/Teplypolzdely/HTK/obogrevcorveliplohdok/CNV-28',
        image: '/images/seris/СНВ-28.png',
      ...
      },
      {
        id: 'termoregulator',
        name: 'ЧТК',
        url: '/Teplypolzdely/HTK/obogrevcorveliplohdok/CN-28',
        image: '/images/seris/СН-28.png',
        logo: '/images/brands/chtklogo.webp',
        description: 'Категория для обогрева кровли и площадок',
      },
];
  ...
  return (
    <div style={{ backgroundColor: 'var(--background)' }} className="min-h-screen text-[var(--foreground)] pt-36 md:pt-32 max-w-[88rem] mx-auto">
      ...
      <Head>
        ...
        <meta name="description" content="Купить  Обогрев кровли и площадок СНВ-28 СН-28 : электронные, с датчиком пола, надежные решения для точного поддержания температуры." />
        <meta property="og:title" content="СНВ-28 — купить обогрев кровли и площадок, ЧТК  | Elektromos" />
        <meta property="og:description" content="Купить Обогрев кровли и площадок СНВ-28 : электронные, с датчиком пола, надежные решения для точного поддержания температуры." />
        <meta property="og:url" content="https://elektromos.uz/Teplypolzdely/HTK/obogrevcorveliplohdok" />
        <meta property="og:image" content="/images/seris/СНВ-28.webp" />
        ...
        <div className="lg:w-1/2 lg:h-screen lg:sticky lg:top-0 bg-[#101010] p-4 sm:p-6 md:p-8 lg:p-7 flex flex-col justify-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-7xl font-medium text-white mb-4 md:mb-6">
           Обогрев кровли и площадок
          </h1>
          <p className="text-white mb-3 md:mb-4 text-sm sm:text-base md:text-lg">
            Откройте для себя превосходные обогрев кровли и площадок – эталон немецкого качества и элегантного дизайна в мире электрики! Выберите свою любимую серию и откройте для себя мир обогрева кровли и площадок!
          </p>
