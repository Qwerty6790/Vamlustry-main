...
const retroData = {
  id: 'retro',
  name: 'Retro',
  description: 'Винтажный стиль для ценителей классической элегантности. Керамика и благородные металлы в сочетании с ретро-формами создают неповторимый шарм. Идеальное решение для лофт-интерьеров и деревянных домов.',
  // Используем одно из изображений как превью для боковой панели
  image: '/images/colors/ретрочерныйWerkel.webp', 
  items: [
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans selection:bg-black selection:text-white flex flex-col pt-28 md:pt-36 overflow-x-hidden">
      <Head>
        ...
        <meta name="description" content="Винтажный стиль и керамика. Серия Retro от Werkel." />
      </Head>
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                ...
                <div className="relative w-full md:w-[300px] h-[200px] md:h-[300px] shrink-0 flex justify-center md:justify-end items-center">
                    <div className="relative w-full h-full">
                       {/* Пространство для баланса композиции (как в главном макете) */}
                    </div>
                </div>
            </div>
        </div>
