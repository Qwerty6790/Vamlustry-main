...
export default function ChampagneMetallicPage() {
  ...
  return (
    <div style={{ backgroundColor: 'var(--background)', minHeight: '100vh', color: 'var(--foreground)' }}>
      <Head>
        <title>Встраиваемая серия Шампань метталик - Werkel | Elektromos</title>
        <meta name="description" content="Встраиваемые серии механизмов с шампань метталик цветом Werkel в Elektromos. Особенности, характеристики, применение в интерьере.Купить в Москве встраиваемые серии Werkel,Купить Розетки и выключатели" />
      </Head>
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-44" style={{ maxWidth: '88rem' }}>
        <div className="mb-8">
          <h2 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-5">Шампань металлик</h2>
