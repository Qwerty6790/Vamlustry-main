...
export default function ChampagneMetallicPage() {
  ...
  return (
    <div style={{ backgroundColor: 'var(--background)', minHeight: '100vh', color: 'var(--foreground)' }}>
      <Head>
        <title>Встраиваемая серия Шампань метталик - Werkel | ВамЛюстра</title>
        <meta name="description" content="Встраиваемые серии механизмов с шампань метталик цветом Werkel в ВамЛюстра. Особенности, характеристики, применение в интерьере.Купить в Москве встраиваемые серии Werkel,Купить Розетки и выключатели" />
      </Head>
