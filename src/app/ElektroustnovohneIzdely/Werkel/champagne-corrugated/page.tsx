...
export default function ChampagneCorrugatedPage() {
  ...
  return (
    <div style={{ backgroundColor: 'var(--background)', minHeight: '100vh', color: 'var(--foreground)' }}>
      <Head>
        <title>Встраиваемая серия Шапань рифленый - Werkel | ВамЛюстра</title>
        <meta name="description" content="Встраиваемые серии механизмов с шапань рифленый Werkel в ВамЛюстра. Особенности, характеристики, применение в интерьере.Купить в Москве встраиваемые серии Werkel,Купить Розетки и выключатели" />
      </Head>
