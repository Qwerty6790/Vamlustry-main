...
<Head>
        <title>Встраиваемая серия Черный акрил - Werkel | Elektromos</title>
        <meta name="description" content="Встраиваемые серии механизмов с черным акрилом Werkel в Elektromos. Особенности, характеристики, применение в интерьере.Купить в Москве встраиваемые серии Werkel,Купить Розетки и выключатели" />
      </Head>

      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-44" style={{ maxWidth: '88rem' }}>
        <div className="mb-8">
          <h2 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-5">Черный акрил</h2>
