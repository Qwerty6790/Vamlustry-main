        ...
        if (WHITELIST_ARTICLES.length === 0) {
          ...
          filteredProducts = data.products.filter((product: any) => {
            ...
            const computerKeywords = [
              'механизм выключателя в1 (простого), 10a 250в~, серия db',
              'механизм выключателя в2 (простого), 10a 250в~, серия db',
              'механизм кнопки звонка 1-но клавишный, 1н.о. 10a 250в~, серия da',
              'механизм выключателя в1 с 2-х мест (проходного), 10a 250в~, серия db',
              'механизм выключателя в3 (простого), 10a 250в~, серия db',
              'механизм выключателя в1 с 3-х мест (перекрёстного), 10a 250в~, серия db',
              'механизм выключателя в2 с 3-х мест (перекрестного), 10a 250в~, серия db',
              'механизм выключателя в2 с 2-х мест (проходного), 10a 250в~, серия db',
              'механизм кнопки звонка 2-х клавишный, 10 A 250 В~, серия db',
              'механизм кнопки звонка 1-но клавишный, 1н.о. 10A 250В~, серия da',
              'механизм кнопки звонка 2-х клавишный, 10 a 250 в~, серия db'
            ];
  ...
  return (
    <div style={{ backgroundColor: 'var(--background)', minHeight: '100vh', color: 'var(--foreground)' }}>
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-44" style={{ maxWidth: '88rem' }}>
        <div className="mb-8">
                    <h2 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-5">Механизмы выключателей</h2>
          ...
          <span>/</span>
          <span className="text-white">Механизмы выключателей</span>
        </nav>
        </div>
