        ...
        if (WHITELIST_ARTICLES.length === 0) {
          ...
          filteredProducts = data.products.filter((product: any) => {
            ...
            const computerKeywords = [
              ...
              'usb зарядное устройство, 12вт тип a,с , серия db',
              'usb зарядное устройство, 20вт тип a,с , серия db',
  ...
  return (
    <div style={{ backgroundColor: 'var(--background)', minHeight: '100vh', color: 'var(--foreground)' }}>
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-44" style={{ maxWidth: '88rem' }}>
        <div className="mb-8">
                    <h2 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-5">Розетки USB</h2>
          ...
          <span>/</span>
          <span className="text-white">Розетки USB</span>
        </nav>
        </div>
