    ...
    try {
      ...
      if (data && data.products) {
        ...
        const filteredProducts = data.products.filter((product: any) => {
          ...
          const isGoldAluminum = name.includes('черный') || name.includes('black') || article.includes('BA');
          
          console.log(`Товар: ${product.name}, артикул: ${article}, A07: ${isA07}, Natural: ${isNatural}, черный: ${isGoldAluminum}`);
          
          return isA07 && isNatural && isGoldAluminum;
        });
        
        console.log(`Найдено товаров A07-Natural-черный: ${filteredProducts.length} из ${data.products.length}`);
