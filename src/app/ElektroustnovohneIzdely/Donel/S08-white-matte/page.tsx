...
export default function S08WhiteMattePage() {
    ...
    try {
      ...
      if (data && data.products) {
        const filteredProducts = data.products.filter((product: any) => {
          ...
          const isMatteWhiteColor = article.endsWith('33') || name.includes('матовый белый') || name.includes('matte white');
          
          return isS08 && isMatteWhiteColor;
        });
  ...
  return (
    <div style={{ backgroundColor: 'var(--background)', minHeight: '100vh', color: 'var(--foreground)' }}>
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-44" style={{ maxWidth: '88rem' }}>
        <div className="mb-8">
          <h2 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-5">Матовый белый</h2>
          ...
          <span>/</span>
          <span className="text-white">S08 Матовый белый</span>
        </nav>
        </div>
