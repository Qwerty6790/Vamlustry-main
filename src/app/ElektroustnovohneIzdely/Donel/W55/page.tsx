...
const w55Data = {
  id: 'w55',
  name: 'W55',
  description: 'Влагозащищенная серия W55 со степенью защиты IP55. Идеальное решение для террас, гаражей, складских помещений и ванных комнат. Высокая ударопрочность, защита от пыли и влаги, устойчивость к ультрафиолету. Выберите тип монтажа, подходящий для вашего проекта.',
