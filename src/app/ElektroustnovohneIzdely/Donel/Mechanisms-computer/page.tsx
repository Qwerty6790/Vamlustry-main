        ...
        if (WHITELIST_ARTICLES.length === 0) {
          ...
          filteredProducts = data.products.filter((product: any) => {
            ...
            const computerKeywords = [
              'механизм розетки rj45 одиночная cat.5/classe-8, серия db',
              'механизм розетки rj45 одиночная cat.6/classe-8, серия db',
              'механизм розетки rj11 + rj45 (двойная) cat.3/5e/classe-4/8, серия db',
              'механизм розетки rj11 + rj45 (двойная) cat.3/6/classe-4/8, серия db',
              'механизм розетки rj45/tv cat.5,classe-8/0-2400 мгц, серия db',
              'механизм розетки rj45/tv cat.6,classe-8/0-2400 мгц, серия db',
              'механизм розетки rj45 + rj45 (двойная) cat.5/classe-8/8, серия db',
              'механизм розетки rj45 + rj45 (двойная) cat.6/classe-8/8, серия db'
            ];
  ...
  return (
    <div style={{ backgroundColor: 'var(--background)', minHeight: '100vh', color: 'var(--foreground)' }}>
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-44" style={{ maxWidth: '88rem' }}>
        <div className="mb-8">
                    <h2 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-5">Розетки компьютерные</h2>
          ...
          <span>/</span>
          <span className="text-white">Розетки компьютерные</span>
        </nav>
        </div>
