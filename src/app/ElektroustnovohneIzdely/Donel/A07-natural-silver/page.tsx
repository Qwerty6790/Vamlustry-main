    ...
    try {
      ...
      if (data && data.products) {
        ...
        const filteredProducts = data.products.filter((product: any) => {
          ...
          const isGoldAluminum = name.includes('cеребристый') || name.includes('silver') || article.includes('SA');
          
          console.log(`Товар: ${product.name}, артикул: ${article}, A07: ${isA07}, Natural: ${isNatural}, серебристый: ${isGoldAluminum}`);
          
          return isA07 && isNatural && isGoldAluminum;
        });
        
        console.log(`Найдено товаров A07-Natural-серебристый: ${filteredProducts.length} из ${data.products.length}`);
    ...
    <div style={{ backgroundColor: 'var(--background)', minHeight: '100vh', color: 'var(--foreground)' }}>
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-44" style={{ maxWidth: '88rem' }}>
        ...
        <div className="mb-8">
          ...
          <span>/</span>
          <span className="text-white">A07 Natural Серебристый алюминий</span>
        </nav>
        </div>
