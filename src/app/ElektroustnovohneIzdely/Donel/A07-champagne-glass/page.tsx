...
export default function A07ChampagneGlassPage() {
    ...
    try {
      ...
      if (data && data.products) {
        const filteredProducts = data.products.filter((product: any) => {
          ...
          const isChampagneGlass = name.includes('champagne') || name.includes('шамп') || article.toLowerCase().includes('cg');
          return isA07 && isNatural && isChampagneGlass;
        });
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-44" style={{ maxWidth: '88rem' }}>
        <div className="mb-8">
          ...
          <nav className="flex flex-wrap items-center gap-1 sm:gap-2 text-sm sm:text-base text-white">
            ...
            <span>/</span>
            <span className="text-white">A07 Natural Шампань стекло</span>
          </nav>
        </div>
