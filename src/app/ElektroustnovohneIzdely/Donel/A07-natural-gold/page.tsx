    ...
    try {
      ...
      if (data && data.products) {
        ...
        const filteredProducts = data.products.filter((product: any) => {
          ...
          const isGoldAluminum = name.includes('золотистый') || name.includes('gold') || article.includes('GA');
          
          console.log(`Товар: ${product.name}, артикул: ${article}, A07: ${isA07}, Natural: ${isNatural}, золотистый: ${isGoldAluminum}`);
          
          return isA07 && isNatural && isGoldAluminum;
        });
        
        console.log(`Найдено товаров A07-Natural-золотистый: ${filteredProducts.length} из ${data.products.length}`);
    ...
    <div style={{ backgroundColor: 'var(--background)', minHeight: '100vh', color: 'var(--foreground)' }}>
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-44" style={{ maxWidth: '88rem' }}>
        ...
        <div className="mb-8">
          ...
          <span>/</span>
          <span className="text-white">A07 Natural Золотистый алюминий</span>
        </nav>
        </div>
