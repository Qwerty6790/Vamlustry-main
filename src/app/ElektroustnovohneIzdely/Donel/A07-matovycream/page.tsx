...
export default function A07CreamPage() {
    ...
    try {
      ...
      if (data && data.products) {
        const filteredProducts = data.products.filter((product: any) => {
          ...
          const isCreamColor = article.endsWith('31') || name.includes('кремовый') || name.includes('cream');
          ...
          return isA07 && isCreamColor && isNotWave && isNotNatural;
        });
  ...
  return (
    <div style={{ backgroundColor: 'var(--background)', minHeight: '100vh', color: 'var(--foreground)' }}>
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-44" style={{ maxWidth: '88rem' }}>
        <div className="mb-8">
          <h2 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-5">Матовый кремовый</h2>
          ...
          <span className="text-white">A07 Матовый кремовый</span>
        </nav>
        </div>
