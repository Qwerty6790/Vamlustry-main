...
// --- Data ---
// Так как блоки от разных брендов, создаем общую "категорию" для дизайна
...
const blocksData = {
  ...
  description: 'Откройте для себя превосходные электроустановочные изделия – эталон качества и элегантного дизайна. Это не просто электрика, это искусство создания совершенного пространства. Идеально подходит для кухонных столешниц, офисных столов и переговорных комнат. Выбирайте качество, выбирайте надежные бренды!',
  // Изображение для иконки в боковом меню и фонового паттерна
      ...
      <div className="max-w-[1800px] mx-auto w-full px-4 lg:px-8 relative mb-8">
        <div className="relative w-full select-none py-4 md:py-10">
           ...
           <div className="flex items-baseline whitespace-nowrap">
              ...
              {/* Category Name (Huge, Dark, Foreground) */}
        ...
        <div className="relative z-30 -mt-16 md:-mt-24 xl:-mt-32 w-full rounded-3xl overflow-hidden bg-white/90 backdrop-blur-sm border border-gray-100 shadow-xl p-8 md:p-12">
            <div className="absolute right-[-5%] top-[-10%] w-[40%] h-[120%] opacity-[0.03] pointer-events-none select-none">
                <Image src={activeSeries.image} alt="" fill className="object-contain grayscale" />
            </div>

            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="max-w-2xl flex-1">
                    <div className="flex items-center gap-3 mb-4">
                        <span className="text-sm font-bold text-gray-400 uppercase tracking-wider">Категория</span>
                        <span className="bg-black text-white text-[10px] px-2 py-0.5 rounded-full">{activeSeries.name}</span>
                    </div>
                    ...
                    >
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] text-gray-400">
                           {activeSeries.items.length} товара
                        </span>
                      </div>
                    </button>
                </div>
