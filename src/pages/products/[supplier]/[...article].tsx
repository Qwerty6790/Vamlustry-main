Вот полный обновленный код файла с интегрированной проверкой от <объект не
найден> в функции isValidFilterValue (строка 43):
...
// Функция для отсеивания мусорных значений вроде "<>", "undefined", "null" и ошибок базы данных
const isValidFilterValue = (val: any): boolean => {
  ...
  // Отсекаем системные битые ссылки из БД 1С
  if (lowerStr.includes('<объект не найден>')) return false;
