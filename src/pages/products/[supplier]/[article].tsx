    ...
    return (
      <div className="mt-10">
        <h3 className="text-[18px] font-medium mb-5">
          {collectionName ? `Коллекция ${collectionName}` : 'Похожие модели'}
        </h3>
        ...
        <div className="min-h-screen bg-white text-neutral-900 font-sans">
          ...
          <main className="max-w-[1500px] mx-auto px-4 md:px-8 pt-24 pb-20">
            ...
            <nav className="flex flex-wrap items-center gap-2 text-[13px] text-gray-500 mb-6 font-light">
              <Link href="/" className="hover:text-black">Minimir.ru</Link>
              ...
              <div className="lg:col-span-7 flex flex-col gap-6">
                <div className={`grid gap-6 ${displayImages.length > 1 ? 'grid-cols-1 md:grid-cols-2' : 'grid-cols-1'}`}>
                  <div className="bg-[#d2d5d6] rounded-3xl relative aspect-[4/4.5] flex items-center justify-center p-8 overflow-hidden group">
                    <button className="absolute top-5 right-5 bg-white/90 text-gray-800 text-[13px] px-5 py-2.5 rounded-full font-medium hover:bg-white transition z-10 shadow-sm">
                    ...
                    />
                    <button className="absolute bottom-5 right-5 bg-white/90 text-gray-800 text-[13px] px-5 py-2.5 rounded-xl font-medium flex items-center gap-2 hover:bg-white transition z-10 shadow-sm">
                      <Search size={16} className="text-gray-600"/> Похожие
                    </button>
                  </div>
                ...
                {/* Баннер */}
                <div className="bg-[#f6f7f7] rounded-3xl p-8 flex flex-col md:flex-row items-center gap-8 relative overflow-hidden mt-2">
                  <div className="flex-1 relative z-10">
                    <h3 className="text-2xl font-medium text-gray-900 mb-3">Вид</h3>
                  ...
                  <div className="flex-1 flex gap-4 opacity-70">
                     <div className="w-32 h-32 bg-white rounded-2xl shadow-sm border border-gray-200 flex items-center justify-center p-2"><img src={getImageUrl(displayImages[0])} className="mix-blend-multiply opacity-50" /></div>
                  </div>
